...
// These are HUMAN edits — recorded in diagram.json like editor changes (no pending refs);
// `artisan diff` picks them up for the agent like any other human change.
